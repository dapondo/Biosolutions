    ...
    <body>
        ...
        <div class="container well ">
            ...
            <form   class="row" method="POST" action="<?php echo "index.php?controller=clientepotencial&action=crear"; ?>">
                ...
                <div class="col-xs-5"><br><textarea class="form-control" id="input-observaciones-consultar" cols="50" rows="10" type="textarea" name="cp_observaciones" placeholder="Observaciones"></textarea></div>
