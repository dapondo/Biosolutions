    ...
    <body>  
        ...
        <div class="container well col-xs-12 col-lg-10 col-lg-offset-1">
            <form  method="POST" action="<?php echo "index.php?controller=cliente&action=consultarcliente"; ?>">
                ...
                <div><input type="submit" class="btn btn-success" name="consultar" value="Consultar" ></div>
                <?php
        ...
        <div class="container well col-xs-12 col-lg-10 col-lg-offset-1">
            <form id="formcliente" method="POST" action="<?php echo "index.php?controller=Cliente&action=modificarbd"; ?>">
                ...
                if ($cli_documento != "") {
                    ...
                    <div class="col-xs-6 col-lg-6"><input class="form-control"  name="cli_paginaWeb" value="<?php echo $cli_paginaWeb; ?>"></div>
                    <div class="col-xs-6 col-lg-6">Dirección</div>
                    <div class="col-xs-6 col-lg-6">Email</div>
                    <div class="col-xs-6 col-lg-6"><input class="form-control" class="form-control" type="text" name="cli_direccion" value="<?php echo $cli_direccion; ?>"></div>
                    <div class="col-xs-6 col-lg-6"><input class="form-control" type="text" name="cli_email" value="<?php echo $cli_email; ?>"></div>
                    <div class="col-xs-6 col-lg-6">Zona Cliente</div>
                    <div class="col-xs-6 col-lg-6">Ciudad</div>
                    <div class="col-xs-6 col-lg-6"><input class="form-control" type="text" name="cli_zonaCliente" value="<?php echo $cli_zonaCliente; ?>"></div>
                    <div class="col-xs-6 col-lg-6"><input class="form-control" type="text" name="cli_ciudad" value="<?php echo $cli_ciudad; ?>"></div>
                    <p class="col-xs-6 col-lg-6">País</p>
                    <p class="col-xs-6 col-lg-6">Nombre</p>
                    <div class="col-xs-6 col-lg-6" id="div-1-7"><input class="form-control" type="text" name="cli_nombre" value="<?php echo $cli_nombre; ?>"></div>
                    <div class="col-xs-6 col-lg-6" id="div-1-7"><input class="form-control" type="text" name="cli_pais" value="<?php echo $cli_pais; ?>"></div>
